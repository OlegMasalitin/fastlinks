  ...
  return (
    <>
      ...
      <div className="flex flex-row flex-nowrap items-center" style={{ width: '160px' }}>
        <Link className="ml-2 text-sky-700" href={`/links/${link.id}/view`}>
          View
        </Link>
        <Link className="ml-2 text-sky-700" href={`/links/${link.id}/edit`}>
          Edit
        </Link>

        <Popover>
          <PopoverTrigger>
            <span className="ml-2 text-sky-700 cursor-pointer">Delete</span>
          </PopoverTrigger>
          <PopoverContent>
